        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              description: `Gain seamless, remote access to manage your data from any location, ensuring flexibility and efficiency. Stay connected and in control of your information at all times.`,
            }}
          />
